    ...
    <header className="bg-white shadow-md py-4 px-8 flex items-center justify-between h-20">
      ...
      <nav className="ml-auto">
        <ul className="flex space-x-6 text-green-700 font-semibold text-lg">
          ...
          <li className="hover:text-green-500 cursor-pointer"><Link to="/RequestSmartBinForm"> Smart bin </Link></li>
          <li className="hover:text-green-500 cursor-pointer"><Link to="/CollectRequestForm">Request Form </Link></li>
